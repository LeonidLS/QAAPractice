...
2) Находясь в директории проекта (в которой уже находится папка allure-results) из командной строки выполнить команды: allure generate  //будет сгенерированы отчеты в формате веб-страниц;
либо allure serve //произойдет запуск stadnalone сервера Allure, c последующим автоматическим вызовом броузера, для отображения сгенерированных отчетов в формате веб-страниц; 
```
